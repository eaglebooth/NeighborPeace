  ...
  return (
    <div className={address ? "notice success" : "notice"}>
      <div className="flex flex-wrap items-center justify-between gap-3">
        <span className="font-bold flex items-center gap-2"><CircleDot size={16} />{address ? "NeighborPeace V3 is configured" : "Awaiting NeighborPeace V3 deployment"}</span>
      ...
      <div className="mt-2 text-sm">{address ? address : "V3 introduces real GEN custody and transfers. Deploy it before enabling writes."}</div>
    </div>
  );
}
